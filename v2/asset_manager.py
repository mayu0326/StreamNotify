...
class AssetManager:
    ...
    def deploy_templates(self, services: list | None = None) -> int:
        """
        テンプレートをコピー
    ...
    def deploy_images(self, services: list | None = None) -> int:
        """
        画像をコピー
    ...
    def deploy_all(self) -> dict:
        ...
        logger.info(f"✅ アセット配置完了: テンプレート {templates_count} 個、画像 {images_count} 個")
